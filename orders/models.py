...
from localflavor.br.models import BRCPFField, BRPostalCodeField, BRStateField # CPF BR
...
class Item(models.Model):
    ...
    price = models.DecimalField(max_digits=10, decimal_places=2) # Preço final da compra
